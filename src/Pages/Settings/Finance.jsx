...
import ExpenseCategory from './ComponentsTable/ExpenseCategory';
import ProductCategory from './ComponentsTable/ProductCategory';
...
const Finance = () => {
  ...
  return (
    <Box>
      ...
      >
        <SettingsHeading Heading="Finance Setting" />
      </Box>
